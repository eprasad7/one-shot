/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: cc47e50658a9d6fc985839e5a2d14fe3)
// Runtime types generated with workerd@1.20260317.1 2026-03-01 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "AgentSandbox";
	}
	interface Env {
		STORAGE: R2Bucket;
		...
		AGENTOS_AGENT: DurableObjectNamespace<import("./src/index").AgentOSAgent>;
		AGENTOS_MCP: DurableObjectNamespace<import("./src/index").AgentOSMcpServer>;
		SANDBOX: DurableObjectNamespace<import("./src/index").AgentSandbox>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DEFAULT_PLAN" | "DEFAULT_PROVIDER" | "DEFAULT_MODEL">> {}
}
